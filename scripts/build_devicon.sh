...
SOURCE_DIR="${REPO_ROOT}/source/devicon"
DIST_DIR="${REPO_ROOT}/dist/Devicon/png"
CURATION_LIST="${REPO_ROOT}/scripts/fixtures/devicon-curation.txt"
...
write_upstream_record "${REPO_ROOT}/dist/Devicon/UPSTREAM-SHA.txt" "${UPSTREAM_SHA}"
